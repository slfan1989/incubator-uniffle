...
public class RssResultPartitionInfo {
  ...
  public String getShuffleId() {
    return FlinkShuffleUtils.toShuffleId(jobID, partitionDescriptor.getResultId());
  }
  ...
  public String getAttemptId() {
    return FlinkShuffleUtils.toAttemptId(producerDescriptor.getProducerExecutionId());
  }
}
